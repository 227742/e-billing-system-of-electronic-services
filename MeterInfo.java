...
public class MeterInfo extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == next) {
			...
			String query = "INSERT INTO meter_info (meter_no, meter_location, meter_type, phase_code, bill_type, days, note) "
					+ "VALUES ('" + meter + "', '" + location + "', '" + type + "', '" + code + "', '" + typebill
					+ "', '" + days + "', 'By Default Bill is calculated for 30 days only')";
